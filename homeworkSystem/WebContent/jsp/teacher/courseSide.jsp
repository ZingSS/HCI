...
<html>
<head>
<link href="<%=localPath%>/css/main.css" rel="stylesheet"
	type="text/css" />
			...
			<s:iterator value="#request.courseList" id="cList">
				...
				<s:if test="#cList.name==#request.course.name">
					<ul class="left-sub-list">
						<li><a id="hw"
							href="showTeacherHomeworkList.action?courseId=<s:property value="course.id"/>&name=<s:property value="course.name"/>">作业</a></li>
						<li><a id="st"
							href="teacherCourse.action?courseId=<s:property value="course.id"/>&name=<s:property value="course.name"/>">学生</a></li>
						<li><a id="an"
							href="getAnnouncement.action?courseId=<s:property value="course.id"/>&name=<s:property value="course.name"/>">公告</a></li>
					</ul>
