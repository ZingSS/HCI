		...
		<div class="right-content">
			<s:if test="%{assistantCourse!=null}">	
				<div id="assistant-course">
					<div id="a-course-title">
						助教课程
					</div>
					<a class="jump-td-a" href="showStudentsHomework.action?courseId=<s:property value="assistantCourse.id"/>&name=<s:property value="assistantCourse.name"/>">
						<div id="a-course-info">
							<div id="a-course-header">
								<%-- <s:property value="assistantCourse.id"/> --%>
			                    <span id="a-course-id"><s:property value="assistantCourse.courseId"/></span>
			                    <span id="a-course-name"><s:property value="assistantCourse.name"/></span>
							</div>
							<div id="a-course-body">
								<span><img alt="上课时间" src="../../image/cal-black.png" class="cal-img"><s:property value="assistantCourse.time"/></span>
								<span><img alt="上课地点" src="../../image/map-black.png" class="map-img"><s:property value="assistantCourse.location"/></span>
								<span><img alt="教师" src="../../image/tea-black.png" class="tea-img"><s:iterator value="assistantCourse.teachers">${ name }  </s:iterator></span>
			...
			<s:iterator value="semesterCourseList" id="semester">
	            ...
	            <a class="jump-td-a" href="showStudentHomeworkList.action?courseId=<s:property value="id"/>&name=<s:property value="name"/>">
	            	<div class="t-course">
						...
						<div class="t-course-body">
							...
							<br/>
							<img alt="上课地点" src="../../image/map-black.png" class="map-img"><span>${ location }</span>
							<br/>
